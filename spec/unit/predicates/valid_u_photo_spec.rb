...
describe 'ValidUPhoto' do
  ...
  it 'does not throw if correct URL' do
    ...
    expect(hcard).to receive(:photo)
      .and_return 'https://firozansari.com/img/profile.jpg'
  ...
  it 'throws if photo is not correct URL' do
    # given
    expect(hcard).to receive(:photo)
      .and_return 'https://firozansari.com/img/profile.jpeg'

    # when
    expect { sut.validate(hcard)}.to raise_error(InvalidMetadataError, 'Photo is not equal to https://firozansari.com/img/profile.jpg')
